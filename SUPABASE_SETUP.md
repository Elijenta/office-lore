...
2. SQL Editor → run `0001_schema.sql`, then `0003_xp_cleanup_triggers.sql`, then `0004_abt_dynasty.sql`. `0002_seed_demo_data.sql` is optional (edit the 3 placeholder emails near the top first if you use it).
